...
export default function Page() {
  return (
    <div>
      ...
      <Text>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <Link href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank" rel="noreferrer">Free Privacy Policy Generator</Link>.</Text>
      ...
      <ListUnorganized>
        ...
        <ListItem>
          <Text><strong>Website</strong> refers to Felipe Scherer&quot;s Blog, accessible from <Link href="https://blog.felipescherer.com">blog.felipescherer.com</Link></Text>
        </ListItem>
        <ListItem>
      ...
      <Text>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the <Link href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking" target="_blank" rel="noreferrer">Free Privacy Policy website</Link> article.</Text>
